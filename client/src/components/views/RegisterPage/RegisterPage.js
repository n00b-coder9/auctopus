...
import background from '../../utils/Images/3.jpeg';
import {
  Form,
  Input,
  Button,
...
function RegisterPage(props) {
  ...
  return (
    <div className='Register-Class' style={{
        ...
        {(props) => {
          ...
          return (
            <div className="app">
              ...
              <Form style={{ minWidth: '375px', backgroundColor: 'whitesmoke', paddingRight: '30px' }} {...formItemLayout} onSubmit={handleSubmit} >
